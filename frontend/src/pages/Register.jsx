...
const Register = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            if (result.success) {
                navigate('/login', { state: { username: data.username, justRegistered: true } })
            }
        } catch (error) {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-purple-100 via-pink-100 to-orange-100">
                <div className="absolute top-20 right-10 w-72 h-72 bg-primary-300/30 rounded-full blur-3xl animate-float"></div>
                <div className="absolute bottom-20 left-10 w-96 h-96 bg-secondary-300/30 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }}></div>
                <div className="absolute top-1/3 left-1/3 w-80 h-80 bg-accent-300/20 rounded-full blur-3xl animate-float" style={{ animationDelay: '1s' }}></div>
            </div>
            ...
            <div className="max-w-md w-full space-y-8 relative z-10">
                ...
                <div className="text-center">
                    <div className="mx-auto h-24 w-24 sweet-gradient rounded-3xl flex items-center justify-center mb-6 shadow-2xl animate-glow">
                        <UserPlus className="h-12 w-12 text-white animate-float" />
                    </div>
                ...
                <div className="card p-10 animate-glow">
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full btn-secondary flex items-center justify-center space-x-3 disabled:opacity-50 disabled:cursor-not-allowed text-base py-4"
                        >
                            {isLoading ? (
                                <>
                ...
                <div className="text-center">
                    <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-6 border-2 border-purple-200 shadow-lg">
                        <h3 className="text-sm font-bold text-gray-800 mb-3">Password Requirements</h3>
                        <div className="text-sm text-gray-700 space-y-2 font-medium text-left">
